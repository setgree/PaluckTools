...
Now that we've [conducted our meta-analyses](meta-analysis-vignette.html), it's time to write the paper. This vignette covers three topics that help with that: functions for summary statistics, a function that helps you turn your database into a bibliography, and some ggplot2-based visualizations that we've found useful.
...
### Turning a database of studies into a bibliography file
...
### Relationship between Standard Error and D
...
### correlation between ideas-based and behavioral outcomes
