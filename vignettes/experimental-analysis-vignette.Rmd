...
This vignette demonstrates tools for analyzing experimental data: `tidy_lm()` for running multiple regression specifications, `robust_se()` for cluster-robust standard errors, and `star_ready()` for preparing results for publication. For more on table formatting, see the "Creating publication-ready tables" vignette.

# Example data

We'll use simulated data from a growth mindset intervention with 2,000 students across 20 schools.
